...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%TODO Ajouter dans les décisions que lorsque l'on créer une liste (ordonnée ou non) la date de la liste est égale à la date du dernier élément  --> Faire cette liaison dans l'interface
