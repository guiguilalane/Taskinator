...
%TODO %%%%%%% A revoir
%TODO %%%%%%%% Est-ce que je donne des valeurs au dates --> Pour l'affichage de la popup
...
%TODO Est-ce que quand il charge une liste à partir d'un template quand il va enregister --> creéer une nouvelle liste comme normalement
...
%TODO A revoir comment on reformule
...
\newpage
\section{L'IHM}
%TODO IHM --> Mettre couleur des dates et mettre que c'est la plus récente quand incohérence de date
...
\end{itemize}
%TODO A modifier dans QT accent sur le é de rétablir {
\begin{figure}[H]
    \center
...
%TODO dire comment on fait nivo widget pour exécuter ces fonctionalités ? ex paramètre juste un "menu" qui s'ouvre ?
\begin{itemize}
...
%TODO Est-ce qu'il faut qu'on mette créer liste ordonnée creer tâche poubelle monter et descendre dans le menu ????? --> A voir avec le prof ?
...
%TODO A compléter quand implémenté

Un élément est représenté avec un ???. %TODO
...
%TODO mettre image pour expliquer
...
%TODO a revoir comment on explique
...
%TODO A revoir Pour cette fonctionnalité, nous avons aussi fait le choix de décocher une tâche si nous déplacons deux tâches non cochées au sein d'une liste ordonnée
