...
Elle ne gère pas non plus la cohérence des dates des composants. Effectivemet dans le cas d'une liste ordonnée, il faudrait vérifier que la date d'une tâche soit inférieure à la date de la tâche suivante. Cette vérification devra se faire lors de la création mais aussi à chaque action effectuée.
...
Ce projet nous a permis de réléchir à la structure de l'IHM, afin que celle-ci soit la plus intuitive possible pour l'utilisateur. Réfléchir à la position des boutons, le nom ou l'icône les représentant. Comment l'ajout des composants se fera au sein de la liste ...
%TODO A compléter
